    ...
    return <li key={tarefaProp.id} className="form-control mt-1">
        <div className="row">
            ...
            <div className="col-md-3 col-sm-4">
                <button onClick={() => { handleDeleteTarefaProp(tarefaProp.id) }} type="button" class="btn btn-danger float-end">Apagar</button>
                <button onClick={() => { handleEditTarefaProp(tarefaProp) }} type="button" class="btn btn-warning float-end">Editar</button>
            </div>
        </div>
    </li>;
}